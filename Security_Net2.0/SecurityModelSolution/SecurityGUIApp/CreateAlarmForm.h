...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Descripcion->Location = System::Drawing::Point(54, 221);
			this->Descripcion->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->Descripcion->Name = L"Descripcion";
			this->Descripcion->Size = System::Drawing::Size(92, 20);
			this->Descripcion->TabIndex = 0;
			this->Descripcion->Text = L"Descripcion";
			// 
			// txtAlarmDescription
			// 
			this->txtAlarmDescription->Location = System::Drawing::Point(58, 260);
			this->txtAlarmDescription->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->txtAlarmDescription->Multiline = true;
			this->txtAlarmDescription->Name = L"txtAlarmDescription";
			this->txtAlarmDescription->Size = System::Drawing::Size(439, 82);
			this->txtAlarmDescription->TabIndex = 1;
			// 
			// label1
			// 
			this->label1->AutoSize = true;
			this->label1->Location = System::Drawing::Point(56, 75);
			...
			this->label2->Location = System::Drawing::Point(56, 132);
			...
			this->btnAddAlert->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnAddAlert->Location = System::Drawing::Point(60, 356);
			this->btnAddAlert->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->btnAddAlert->Name = L"btnAddAlert";
			this->btnAddAlert->Size = System::Drawing::Size(88, 46);
			...
			// dtpStartingDate
			// 
			this->dtpStartingDate->Location = System::Drawing::Point(187, 76);
			this->dtpStartingDate->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->dtpStartingDate->Name = L"dtpStartingDate";
			this->dtpStartingDate->Size = System::Drawing::Size(202, 20);
			this->dtpStartingDate->TabIndex = 7;
			this->dtpStartingDate->Value = System::DateTime(2025, 6, 17, 9, 7, 38, 0);
			// 
			// dtpEndingDate
			// 
			this->dtpEndingDate->Location = System::Drawing::Point(187, 132);
			this->dtpEndingDate->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->dtpEndingDate->Name = L"dtpEndingDate";
			this->dtpEndingDate->Size = System::Drawing::Size(202, 20);
			this->dtpEndingDate->TabIndex = 8;
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Location = System::Drawing::Point(56, 184);
			...
			this->cmbAlarmType->Location = System::Drawing::Point(187, 184);
			this->cmbAlarmType->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->cmbAlarmType->Name = L"cmbAlarmType";
			this->cmbAlarmType->Size = System::Drawing::Size(158, 21);
			...
			this->ClientSize = System::Drawing::Size(584, 438);
