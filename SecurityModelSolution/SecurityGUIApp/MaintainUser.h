...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dgvMaintainUser->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &MaintainUser::dgvMaintainUser_CellContentClick);
			// 
			// Username
			// 
...
#pragma endregion
    ...
    private: System::Void dgvMaintainUser_CellContentClick(System::Object^ sender, System::Windows::Forms::DataGridViewCellEventArgs^ e) {
		String^ username = dgvMaintainUser->Rows[dgvMaintainUser->SelectedCells[0]->RowIndex]->Cells[2]->Value->ToString();
